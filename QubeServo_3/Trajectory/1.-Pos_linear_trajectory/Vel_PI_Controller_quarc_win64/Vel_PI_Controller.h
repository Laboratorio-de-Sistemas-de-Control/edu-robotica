...
#ifndef Vel_PI_Controller_h_
#define Vel_PI_Controller_h_
#ifndef Vel_PI_Controller_COMMON_INCLUDES_
#define Vel_PI_Controller_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Vel_PI_Controller_COMMON_INCLUDES_ */
...
#define Vel_PI_Controller_rtModel      RT_MODEL_Vel_PI_Controller_T
...
} B_Vel_PI_Controller_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_FilterFrequency[2];/* '<Root>/HIL Initialize' */
  real_T HILReadTimebase_OtherBuffer;  /* '<Root>/HIL Read Timebase' */
  ...
  int32_T HILReadTimebase_EncoderBuffer;/* '<Root>/HIL Read Timebase' */
  struct {
    int_T PrevIndex;
  } FromWorkspace_IWORK;               /* '<Root>/From Workspace' */
} DW_Vel_PI_Controller_T;

/* Continuous states (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} X_Vel_PI_Controller_T;

/* State derivatives (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_Vel_PI_Controller_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_Vel_PI_Controller_T;
...
#define rtB                            Vel_PI_Controller_B
#define BlockIO                        B_Vel_PI_Controller_T
#define rtX                            Vel_PI_Controller_X
#define ContinuousStates               X_Vel_PI_Controller_T
#define rtXdot                         Vel_PI_Controller_XDot
#define StateDerivatives               XDot_Vel_PI_Controller_T
#define tXdis                          Vel_PI_Controller_XDis
#define StateDisabled                  XDis_Vel_PI_Controller_T
#define rtP                            Vel_PI_Controller_P
#define Parameters                     P_Vel_PI_Controller_T
#define rtDWork                        Vel_PI_Controller_DW
#define D_Work                         DW_Vel_PI_Controller_T

/* Parameters (default storage) */
struct P_Vel_PI_Controller_T_ {
  ...
  real_T HILInitialize_OOWatchdog[3];  /* Expression: watchdog_other_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Gain1_Gain;                   /* Expression: 2*pi/(512*4)
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T Gain2_Gain;                   /* Expression: 2*pi/(512*4)
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T Gain_Gain;                    /* Expression: 0.58
...
struct tag_RTM_Vel_PI_Controller_T {
  const char_T *path;
...
extern P_Vel_PI_Controller_T Vel_PI_Controller_P;

/* Block signals (default storage) */
extern B_Vel_PI_Controller_T Vel_PI_Controller_B;

/* Continuous states (default storage) */
extern X_Vel_PI_Controller_T Vel_PI_Controller_X;

/* Disabled states (default storage) */
extern XDis_Vel_PI_Controller_T Vel_PI_Controller_XDis;

/* Block states (default storage) */
extern DW_Vel_PI_Controller_T Vel_PI_Controller_DW;

/* Model entry point functions */
extern void Vel_PI_Controller_initialize(void);
extern void Vel_PI_Controller_output(void);
extern void Vel_PI_Controller_update(void);
extern void Vel_PI_Controller_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Vel_PI_Controller_rtModel *Vel_PI_Controller(void);
...
extern RT_MODEL_Vel_PI_Controller_T *const Vel_PI_Controller_M;
 ...
 *
 * '<Root>' : 'Vel_PI_Controller'
 * '<S1>'   : 'Vel_PI_Controller/Powered by QUARC'
 * '<S2>'   : 'Vel_PI_Controller/Quanser'
 */
#endif                                 /* Vel_PI_Controller_h_ */
