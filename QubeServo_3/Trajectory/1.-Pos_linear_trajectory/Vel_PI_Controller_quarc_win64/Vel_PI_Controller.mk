###########################################################################
## Makefile generated for component 'Vel_PI_Controller'. 
## 
## Makefile     : Vel_PI_Controller.mk
## Generated on : Fri May 15 17:44:17 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Vel_PI_Controller.rt-win64
...
PRODUCT_NAME              = Vel_PI_Controller
MAKEFILE                  = Vel_PI_Controller.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\GitHub\UCuenca_Pracs\Robotics\QubeServo_3\Trajectory\1.-Pos_linear_trajectory
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Vel_PI_Controller_comp.rsp
CMD_FILE                  = Vel_PI_Controller.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
CFLAGS_ADDITIONAL     = $(SUPRESS_WARNINGS) -D_CRT_SECURE_NO_DEPRECATE -D_UCRT_NOISY_NAN
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Vel_PI_Controller.rt-win64
...
DEFINES_STANDARD = -DMODEL=Vel_PI_Controller -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller.c $(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller_data.c $(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller_main.c $(START_DIR)\Vel_PI_Controller_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Vel_PI_Controller.obj Vel_PI_Controller_data.obj Vel_PI_Controller_main.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Vel_PI_Controller_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Vel_PI_Controller_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Vel_PI_Controller.obj : "$(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller.c"


Vel_PI_Controller_data.obj : "$(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller_data.c"


Vel_PI_Controller_main.obj : "$(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Vel_PI_Controller_quarc_win64\Vel_PI_Controller_main.c"


rt_nonfinite.obj : "$(START_DIR)\Vel_PI_Controller_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Vel_PI_Controller_quarc_win64\rt_nonfinite.c"
